...
export default function KoebBoeger() {
    ...
    return (
        ...
        <section>
            ...
            <div className="kategoriCard">
                <img src={tilbud} alt="Ugens tilbud" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={signerede} alt="Signerede bøger" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={klub} alt="KFM læseklubberne læser" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={skonlitteratur} alt="Skønlitteratur" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={biografier} alt="Biografier" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={borneboger} alt="Børnebøger" className="kategoriImg" />
            ...
            <div className="kategoriCard">
                <img src={moleskine} alt="Moleskine notesbøger og kalendere" className="kategoriImg" />
                <p className="kategoriTxt">Moleskine notesbøger og kalendere</p>
                </div>
            </NavLink>
