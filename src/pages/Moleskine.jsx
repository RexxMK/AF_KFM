...
export default function Moleskine({ book }) {
  ...
  Hvis en bog indeholder tekststrengen barn (vi har ingen moleskine i JSON-filen, så dette er bare som eksempel) i kategoriattributten returneres true. Ellers false.
