...
export default function Skonlitteratur({ book }) {
  ...
  Hvis en bog indeholder tekststrengen skonlitteratur i kategoriattributten returneres true. Ellers false.
  Hvis der returneres true, vises elementet i skyggelisten. Ellers ikke. */

  const kategoriListe = books.filter((book) =>
    book.kategori.includes("skonlitteratur")
  );
      ...
      <div className="pageContainer">
        <div className="pageFlex">
          <div className="katUnderside">
            ...
            <KategoriUnderside
              headingText={"Skønlitteratur"}
              katText={""}
              antalText={"Viser 48 af 339 produkter"}
              books={books}
              setBooks={setBooks}
            />
