...
export default function Lyrik({ book }) {
  ...
  Hvis en bog indeholder tekststrengen lyrik i kategoriattributten returneres true. Ellers false.
  Hvis der returneres true, vises elementet i skyggelisten. Ellers ikke. */

  const kategoriListe = books.filter((book) => book.kategori.includes("lyrik"));
