        ...
        <section className="venstreBokse">
            ...
            <div className="venstreBoks">
                ...
                <div className="venstreBoksLinks">
                    ...
                    <p className="kategoriPunkt">Maggie O'Farrell, Portræt af en ung brud <span className="smallDate">03/10 2023</span></p>
                    <p className="kategoriPunkt">Gilgamesh <span className="smallDate">03/10 2023</span></p>
                    <p className="kategoriPunkt">Vigdis Hjorth, Femten år <span className="smallDate">03/10 2023</span></p>
                </div>
            ...
            <div className="venstreBoks">
                ...
                <div className="venstreBoksLinks">
                    ...
                    <img src={FacebookImg} alt="Billede af KFM's Facebookside." className="facebookImg" />
